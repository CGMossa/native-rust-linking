...
- [`corpus.md`](corpus.md) — survey of 52 extendr R packages: how often a Rust R
  package needs a Rtools system library at all (2 of 52), and what the rest do
  instead (pure-Rust crates, or vendored C/C++).
